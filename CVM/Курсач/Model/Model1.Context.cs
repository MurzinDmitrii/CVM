...
namespace Курсач.Model
{
    ...
    public partial class CVMEntities4 : DbContext
    {
        public CVMEntities4()
            : base("name=CVMEntities4")
        {
        }
        ...
        public virtual DbSet<ExercisesList> ExercisesList { get; set; }
        ...
        public virtual int AddExercisesList(Nullable<int> clientId, Nullable<int> exercisesId, Nullable<int> quantity)
        {
            var clientIdParameter = clientId.HasValue ?
                new ObjectParameter("ClientId", clientId) :
                new ObjectParameter("ClientId", typeof(int));
    
            var exercisesIdParameter = exercisesId.HasValue ?
                new ObjectParameter("ExercisesId", exercisesId) :
                new ObjectParameter("ExercisesId", typeof(int));
    
            var quantityParameter = quantity.HasValue ?
                new ObjectParameter("Quantity", quantity) :
                new ObjectParameter("Quantity", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AddExercisesList", clientIdParameter, exercisesIdParameter, quantityParameter);
        }
        ...
        public virtual int DeleteExercisesList(Nullable<int> clientId, Nullable<int> exercisesId)
        {
            var clientIdParameter = clientId.HasValue ?
                new ObjectParameter("ClientId", clientId) :
                new ObjectParameter("ClientId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DeleteExercisesList", clientIdParameter, exercisesIdParameter);
        }
    }
}
